#!/usr/bin/env node
/**
 * REPORT GENERATOR V11 - 7 CRITICAL FIXES
 * 
 * FIX 1: Hero dominates viewport (90vh)
 * FIX 2: Remove duplicate soft CTA
 * FIX 3: Add section intros (handholding)
 * FIX 4: Tighten all content (max 2 sentences/paragraph)
 * FIX 5: Math must validate (±15%)
 * FIX 6: Competitor data validation (no all-identical)
 * FIX 7: TLDR ≠ Insight (prevent duplication)
 * 
